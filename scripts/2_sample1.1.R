...
geo <- list(
  "Antarctic" = -90L,
  "South temperate zone" = -66.5635,
  "Tropics" = -23.4365,
  "North temperate zone" = 66.5635,
  "Arctic" = 90L
)
