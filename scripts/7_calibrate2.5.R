...
set(x = dt_cal, j = "rto",  value = sim$thr_rto) # Thrust reduction in %
...
fn_calibrate <- function(clmax, i) {
  ...
  # Calculate the ground component of the simulated TODR
  set(
    x = dt_tko,
    i = i,
    j = "dis_gnd_sim",
  ...
  # Set the airborne component of the simulated TODR
  set(
    x = dt_tko,
    i = i,
    j = "dis_air_sim",
