...
fn_simulate <- function(icao) {
  ...
  # ============================================================================
  # 2.2 Assemble the simulation inputs
  # ============================================================================
  ...
  # Initialize a counter only to keep track of the number of takeoff iterations
  itr <- 0L
  ...
  repeat {
    ...
    if (length(i) > 0) {
      ...
      set(
        ...
        i = i,
        j = "m",
        value = ifelse(dt_tko[i, rto] == 0L, dt_tko[i, m] - 87L, dt_tko[i, m])
      )
      ...
      set(
        ...
        i = i,
        j = "rto",
        value = ifelse(dt_tko[i, rto] > 0L, dt_tko[i, rto] - 1L, dt_tko[i, rto])
      )
