...
# print(summary(dt_tko[i, cL]))
      ...
      set(x = dt_tko, i = i, j = "W", value = fn_W(dt_tko[i, ]))
...
# FOR TESTING ONLY
# print("todr_gnd is:")
# print(summary(dt_tko[i, todr_gnd]))
      ...
      set(
        ...
        i = i,
        j = "todr_reg",
        value = (dt_tko[i, todr_gnd] + dt_tko[i, todr_air]) *
          (sim$tod_mul - 1)
      )
